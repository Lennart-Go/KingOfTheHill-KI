...
//
//    List<t_move_old> moves = generate_moves(game, false);
...
//    List<t_move_old> moves = generate_moves(game, true);
...
//    List<t_move_old> moves = generate_moves(game, 0);
//    EXPECT_EQ(28, moves.length());
//}
//
//// Stellung nicht erlaubter En passant (Gruppe B), last move_old: pc6->c5
...
//    List<t_move_old> moves = generate_moves(game, 1);
